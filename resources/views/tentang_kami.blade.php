    ...
    <div class="px-4 py-12 md:px-12">
        <div class="pb-10 card">
            <div class="block py-10 text-center">
                <h1 class="inline text-2xl font-bold uppercase border-b-2 text-primary border-primary">tentang kami
                </h1>
            </div>
            <div class="flex flex-col space-y-4 md:pt-4 md:space-y-0 md:flex-row md:space-x-4">
                ...
                <div class="flex flex-col flex-1 space-y-4">
                    <h1 class="text-xl font-semibold uppercase text-primary">Jelajahi</h1>
                ...
                <div class="flex flex-col flex-1 space-y-4">
                    <h1 class="text-xl font-semibold uppercase text-primary">Media Sosial</h1>
                    <div class="flex flex-col space-y-2 capitalize text-default">
