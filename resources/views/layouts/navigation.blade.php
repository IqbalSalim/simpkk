<nav x-data="{ open: false }" class="border-b border-gray-100 bg-secondary">
        ...
        <div class="flex justify-between py-2">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="flex items-center text-sm font-medium text-white transition duration-150 ease-in-out hover:text-warning hover:border-gray-300 focus:outline-none focus:text-warning focus:border-gray-300">
                            <div>{{ Auth::user()->anggota->nama }}</div>
