                    ...
                    <div class="flex flex-col flex-1 px-4 py-2 overflow-auto h-96">
                        <div class="flex flex-col space-y-4 md:items-center md:flex-row md:space-x-4">
                            ...
                            <div class="flex-1 mt-4">
                                ...
                                <x-input wire:model.defer="judul" id="judul" class="block w-full mt-1 text-sm"
                                    type="text" name="judul" autofocus />
                    ...
                    @foreach ($wartas as $warta)
                        <div class="relative z-0 flex-col space-y-4 bg-white shadow-2xl rounded-xl">
                            ...
                            <div
                                ...
                                <button @click="modalEdit = true" wire:click="getWarta({{ $warta->id }})"
                                    type="button" class="btn-secondary">Edit</button>
                                <button wire:click="delete({{ $warta->id }})" type="button"
